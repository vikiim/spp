      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="dashboard_petugas.php"><i class="fa fa-tachometer fa-fw" aria-hidden="true"></i>Dashboard</a></li>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li><a href="dashboard_petugas.php"><i class="fas fa-history fa-fw" aria-hidden="true"></i>Riwayat Pembayaran <span class="sr-only">(current)</span></a></li>
