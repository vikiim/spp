...
<link href="/your-path-to-fontawesome/css/all.css" rel="stylesheet">
  ...
  <body>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="laporan.php"><i class="fa fa-file-text fa-fw" aria-hidden="true"></i>Laporan</a></li>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">LAPORAN</h2>
    ...
    <tr>
      ...
      <td>
      <a href="laporan_siswa.php" target="_blank"><button class="btn btn-primary btn-sm" ><i class="fas fa-print fa-2x"></i></button></a>
      </td>
    </tr>
