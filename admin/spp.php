    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">DAFTAR DATA SPP</h2>
          <div class="table-responsive">
            <table class="table table-striped" cellpadding="10" cellspacing="0">
              <button class="btn btn-primary box-title"><a href="tambah-spp.php" style="color: white;"><i class="fa fa-user-plus"></i></a></button>
...
<?php foreach ( $spp as $row ) :
 ...
 ?>
              <tbody>
              	...
              	<td><?= $row["nominal"]; ?></td>
              	<td>
              		<button class="btn btn-warning"><a href="edit-spp.php?id_spp=<?= $row["id_spp"]; ?>" style="color: white;"><i class="fa fa-edit"></i></a></button> 
				          <button class="btn btn-danger">
                    <a href="hapus-spp.php?id_spp=<?= $row["id_spp"]; ?>" style="color: white;" 
