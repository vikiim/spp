      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="kelas.php"><i class="fas fa-school"></i>Data Kelas</a></li>
          </ul>
          <ul class="nav nav-sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">DAFTAR DATA KELAS</h2>
          <div class="table-responsive">
            <table class="table table-striped" cellpadding="10" cellspacing="0">
              <button class="btn btn-success"><a href="tambah-kelas.php" style="color: white;"><i class="fa fa-user-plus"></i></a></button>
              <thead>
                <tr>
                	<th>No</th>
                  <th>KELAS</th>
 ...
 ?>
              <tbody>
              	...
              	<td>
                    ...
                    <a href="edit-kelas.php?id_kelas=<?= $row["id_kelas"]; ?>" style="color: white;"><i class="fa fa-edit"></i></a></button> 
				          <button class="btn btn-danger">
                    <a href="hapus-kelas.php?id_kelas=<?= $row["id_kelas"];?>
                    " onclick="return confirm('Apakah anda yakin ingin menghapus data ini');" style="color: white;"><i class="fa fa-user-times"></i></a>
                  </button> 
              	</td>
              	</tr>
              	<?php $i++; ?>
