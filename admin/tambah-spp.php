...
if (isset($_POST["submit-spp"])) {
  ...
  if ( tambah_spp($_POST) > 0 ) {
    ...
    document.location.href = 'tambah-spp.php';
    </script>
    ";
  }
}
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Form Tambah Data Spp</h2>
          ...
          <br>
          <div class="mb-3">
            <button type="submit" name="submit-spp" class="btn btn-block btn-success">Tambah</button>
          </div>
           </form> 
          </div>
        </div>
