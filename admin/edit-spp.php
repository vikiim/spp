...
if (isset($_POST["submit-spp"])) {
  ...
  if ( edit_spp($_POST) > 0 ) {
    ...
    document.location.href = 'edit-spp.php';
    </script>
    ";
  }
}
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li><a href="spp.php">Data Spp <span class="sr-only">(current)</span></a></li>
            <li class="active"><a href="tambah-spp.php">Tambah Data Spp</a></li>
          </ul>
        </div>
...
<div class="row placeholders">
          ...
          <h2 class="sub-header">Form Edit Data Spp</h2>
          <div class="table-responsive">
           <form action="" method="post">
            <input type="hidden" name="id_spp" value="<?= $spp["id_spp"]; ?> ">
                      <div class="mb-3">
            <label for="tahun" class="form-label">Tahun</label>
            <input type="text" name="tahun" class="form-control" id="tahun" value="<?= $spp["tahun"]; ?> " required>
          </div>
          <div class="mb-3">
            <label for="nominal" class="form-label">Nominal</label>
            <input type="text" name="nominal" class="form-control" id="nominal" value="<?= $spp["nominal"]; ?> " required>
          </div>
          <br>
          <div class="mb-3">
            <button type="submit" name="submit-spp" class="btn btn-block btn-success">Edit Data</button>
          </div>
           </form> 
          </div>
        </div>
